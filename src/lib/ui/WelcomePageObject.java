...
public class WelcomePageObject extends MainPageObject {
  ...
  public void waitForAddOrEditPreferredLangText() {
    this.waitForElementPresent(STEP_ADD_OR_EDIT_PREFERED_LANG_LINK, "Cannot find 'Add or edit preferred languages' link", 10);
  }
  ...
  public void clickNextButton() {
    this.waitForElementAndClick(NEXT_BTN, "Cannot find and click 'Next' link", 10);
  }
